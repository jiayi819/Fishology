...
function help(){
	if(!clickDisabled){
		...
		document.getElementById("theDiaryViewTXT").innerHTML = "<br><br>1. Wait until no fish around before clicking a button.<br><br>2. If a button won't work, click more times.<br><br>3. Sign in/up here to access personal diary space.<br><br>Enjoy! : D";	
	}
}
